; Local override of Neovim's markdown highlights query.
; Keep fence markers/info strings styled, but do not capture the entire fenced
; block as raw text. That allows injected language highlights inside fenced
; blocks to show through, including our selective italic rules.
